...
object BackgroundMapper {
    ...
    val backgroundMap = mapOf(
        "01d" to Brush.linearGradient(listOf(Color(0xFFfdfbfb), Color(0xFFebedee))), // Clear sky (day)
        ...
        "10d" to Brush.linearGradient(listOf(Color(0xFF373B44), Color(0xFF4286F4))), // Rain (day)
