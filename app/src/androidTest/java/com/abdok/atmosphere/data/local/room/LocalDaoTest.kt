...
class LocalDaoTest {
    ...
    fun insertAlert_getAllAlerts() = runTest {
        ...
        val insertionResult = dao.insertAlert(alert)
        val list = dao.getAllAlerts().first()
        val result = list[0]
    ...
    fun deleteAlert_shouldRemoveItem() = runTest {
        ...
        val deletionResult = dao.deleteAlert(alert)
        val list = dao.getAllAlerts().first()
    ...
    fun deleteAlertById_shouldRemoveItem() = runTest {
        ...
        dao.insertAlert(alert)
        val deletionResult = dao.deleteAlertById(alert.id)
        val list = dao.getAllAlerts().first()
    ...
    fun insertFavouriteLocation_and_getAllFavouriteLocations() = runTest {
        ...
        val insertionResult =dao.insertFavouriteLocation(location)
        val locations = dao.getAllFavouriteLocations().first()
    ...
    fun updateFavouriteLocation_and_getAllFavouriteLocations() = runTest {
        ...
        dao.insertFavouriteLocation(location)

        val newLatLng = LatLng(31.0444, 32.2357)
        val updatedLocation = location.copy(location = newLatLng)
        val updateResult = dao.updateFavouriteLocation(updatedLocation)
        val locations = dao.getAllFavouriteLocations().first()
    ...
    fun deleteFavouriteLocation_and_getAllFavouriteLocations() = runTest {
        ...
        val deletionResult = dao.deleteFavouriteLocation(location)
        val list = dao.getAllFavouriteLocations().first()
